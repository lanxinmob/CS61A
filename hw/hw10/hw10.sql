...
CREATE TABLE sentences AS
  SELECT 'The two siblings, ' || one ||' and '|| two ||', have the same size: '||a.size AS sed FROM siblings,size_of_dogs AS a,size_of_dogs AS b WHERE one = a.name AND two = b.name  AND a.size = b.size;
