...
def play(strategy0, strategy1, update,
    ...
    while score0<goal and score1<goal:
         if who == 0 :score0= update(strategy0(score0,score1), score0, score1, dice)
...
def is_always_roll(strategy, goal=GOAL):
    ...
    "*** YOUR CODE HERE ***"
    temp = strategy(0,0)
    for sco1 in range(0,goal,1):
        for sco2 in range(0,goal,1):
            if strategy(sco1,sco2)!=temp:return False
            temp = strategy(sco1,sco2)
    return True
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    max_num_roll,sum = 1,0
    for i in range(2,11,1):
       num = average_dice(i,dice)
       sum = average_dice(max_num_roll,dice)
       if num>sum:
           sum = num
           max_num_roll=i
    return max_num_roll
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # BEGIN PROBLEM 12
    for i in range(0,3):
        if simple_update(i,score,opponent_score)>=GOAL:
            return i
