...
def calc_eval(exp):
    ...
    if isinstance(exp, Pair):
        ...
        return exp
    elif exp or exp.first in bindings.keys(): # CHANGE THIS CONDITION FOR Q4
...
def eval_and(expressions):
    ...
    if expressions.first is False:
        return False
    else:return eval_and(expressions.rest)
